...
public class CategorieController implements Serializable {
    ...
    @EJB
    private com.davidhodin.freeerp.data.CategorieFacade ejbFacade;
    ...
    public static class CategorieControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Categorie) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + CategorieController.class.getName());
            }
        }
    }
}
