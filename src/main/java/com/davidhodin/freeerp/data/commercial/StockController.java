...
import com.davidhodin.freeerp.data.commercial.StockFacade;
...
public class StockController implements Serializable {
    ...
    @EJB private com.davidhodin.freeerp.data.commercial.StockFacade ejbFacade;
    ...
    public static class StockControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Stock) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+StockController.class.getName());
            }
        }
