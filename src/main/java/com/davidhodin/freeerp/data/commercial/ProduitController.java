...
import com.davidhodin.freeerp.data.commercial.ProduitFacade;
...
public class ProduitController implements Serializable {
    ...
    @EJB private com.davidhodin.freeerp.data.commercial.ProduitFacade ejbFacade;
    ...
    public static class ProduitControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Produit) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+ProduitController.class.getName());
            }
        }
