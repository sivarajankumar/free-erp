...
import com.davidhodin.freeerp.data.commercial.ServiceFacade;
...
public class ServiceController implements Serializable {
    ...
    @EJB private com.davidhodin.freeerp.data.commercial.ServiceFacade ejbFacade;
    ...
    public static class ServiceControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Service) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: "+ServiceController.class.getName());
            }
        }
