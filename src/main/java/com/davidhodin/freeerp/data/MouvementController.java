...
import com.davidhodin.freeerp.data.MouvementFacade;
...
@ManagedBean(name = "mouvementController")
@SessionScoped
public class MouvementController implements Serializable {
    ...
    @EJB
    private com.davidhodin.freeerp.data.MouvementFacade ejbFacade;
    ...
    public static class MouvementControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Mouvement) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + MouvementController.class.getName());
            }
        }
    }
}
